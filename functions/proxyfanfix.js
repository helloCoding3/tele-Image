export async function onRequest(context) {
  ...
  if (request.method === "POST") {
    ...
    myHeaders.append("Host", "service-graphql-prod.fanfix.io");
    myHeaders.append(
      "User-Agent",
    ...
    myHeaders.append("Referer", "https://app.fanfix.io/");
    myHeaders.append("Authorization", request.headers.get("authorization"));
    myHeaders.append("Origin", "https://app.fanfix.io");
    ...
    const response = await fetch(
      "https://service-graphql-prod.fanfix.io/upload",
      requestOptions
    );
